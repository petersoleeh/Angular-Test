...
@Component({
  ...
  <div class="container">
    ...
    <h3>One of the brands i know is: {{favoriteBand}}</h3>
      <p> If i had to pick a painter it would be: {{favoritePainter}}</p>
      <p>The number of slices in a pie is: {{slicesOfpie}}</p>
...
export class AppComponent {
  ...
  slicesOfpie: number = 6;
  favoriteAlbum: Album = new Album("Disintergration", "The cure", 1990);
